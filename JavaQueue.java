...
private static void createQueue() {
    ...
    int alpha = 0;
    while(loopX == 0) {
        System.out.print("Masukkan Antrian (angka): ");
...
private static void menuChooser(int choosenMenu) {
    switch(choosenMenu) {
        ...
        case 3:        
            ...
            System.out.println("MAAF PAK UNTUK MENU HAPUS ANTRIAN TERTENTU BELUM");
...
private static void menuProgram() {
    ...
    int choosenMenu = 0;
    while(loopX == 0) {
        System.out.println("\nAntrian di Bank Mangkiri");
        System.out.println("Menu: ");
        System.out.println("1. Tambah Data Antrian");
        System.out.println("2. Menghapus Data Antrian pada elemen pertama");
        System.out.println("3. Menghapus Data Antrian pada posisi tertentu");
        System.out.println("4. Tampilkan data dalam Antrian");
